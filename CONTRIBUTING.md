...
* **feat**: Syndicator new feature
* **fix**: Syndicator bug fix
* **docs**: Documentation only changes
* **style**: Changes that do not affect the meaning of the code (white-space, formatting, missing
  semi-colons, etc)
* **refactor**: Syndicator code change that neither fixes a bug nor adds a feature
* **perf**: Syndicator code change that improves performance
